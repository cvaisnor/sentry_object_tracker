...
class YOLOTracker:
    def __init__(self, camera_id=0, model_path="models/yolov8n.pt"):
        ...
        # initialize system when object is created
    ...
    def draw_tracking_info(self, frame, box, confidence, target_position):
        ...
        # Draw system status
        status_text = "NORMAL" if self.is_initialized else "NOT INITIALIZED"
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # Find target object
                target_position, confidence, box = self.find_target_object(boxes, 
                                                                           confidences, 
                                                                           class_ids, 
